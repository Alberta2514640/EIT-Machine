...
# The structure of the command word differs slightly from the AD9512 and the AD9106. These functions can be changed to just take a
# command word which is generated by helper functions in the chips' individual drivers.
